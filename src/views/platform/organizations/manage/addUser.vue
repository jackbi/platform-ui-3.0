 ...
 * @LastEditors: wenbin
 * @LastEditTime: 2022-05-19 10:37:41
 * @FilePath: /magus-platform-ui-3.0/src/views/platform/organizations/manage/addUser.vue
    ...
    const methods = {
      ...
      goSave() {
        ...
        proxy.$magusCloudApi.apiConfig
          .post(orgApi.saveAuthUsers, { userIds, orgId })
          .then(() => {
            proxy.$message({
              type: 'success',
      ...
      getAuthUsers() {
        ...
        proxy.$magusCloudApi.apiConfig
          .get(orgApi.getUnAuthUsers, state.query)
          .then((res) => {
